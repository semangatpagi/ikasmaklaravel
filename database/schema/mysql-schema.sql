...
CREATE TABLE `membership_payments` (
  ...
  KEY `membership_payments_verified_by_foreign` (`verified_by`),
  CONSTRAINT `membership_payments_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `membership_payments_verified_by_foreign` FOREIGN KEY (`verified_by`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `kota_rumah` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `provinsi_kantor` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kota_kantor` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `role` enum('unverified','member','member_plus','admin','super_admin') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unverified',
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (4,'2025_03_24_021720_update_users_table_for_alumni_system',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2025_03_24_021808_create_membership_payments_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2025_03_31_195449_add_birthdate_fields_to_users_table',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2025_04_04_024441_add_social_media_fields_to_users_table',4);
